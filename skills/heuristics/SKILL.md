...
**This file is the canonical catalog.** Other skills and agents reference these lenses *by name* (e.g. "apply Goldilocks and Follow the Data") instead of re-listing them, and `HEURISTICS.md` at the plugin root is a one-page pointer into this file. When you add a heuristic, add it here.
